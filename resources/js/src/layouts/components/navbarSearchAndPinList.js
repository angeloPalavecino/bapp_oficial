export default {
  ...
  data: [
    ...
    {index: 1, label: 'Roles', url: '/pages/administracion/roles/roles', labelIcon: 'UserCheckIcon', highlightAction: false},
    {index: 2, label: 'Usuarios', url: '/pages/administracion/users/users', labelIcon: 'UsersIcon', highlightAction: false},
    {index: 3, label: 'Config. Cuenta', url: '/pages/administracion/empresas/empresas', labelIcon: 'GlobeIcon', highlightAction: false},
    {index: 4, label: 'Excepciones', url: '/pages/administracion/excepciones/excepciones', labelIcon: 'AlertCircleIcon', highlightAction: false},
