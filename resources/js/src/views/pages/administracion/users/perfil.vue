        ...
        <div class="profile-header">
            <div class="relative">
                <div class="cover-container rounded-t-lg">
                    <img src="../../../../../../assets/images/profile/user-uploads/cover.jpg" alt="user-profile-cover"  class="responsive block">
                </div>
                <div class="profile-img-container pointer-events-none">
                    <div>
                        <vs-avatar class="user-profile-img" :src="require(`../../../../../../assets/images/profile/avatar/${item.imagen}`)" size="120px" />
                    </div>
         ...
         <vx-card class="mt-base">
          ...
          <div class="vx-row">
            ...
            <div class="vx-col w-1/2 mb-3 mt-4">
               ...
               <h4 style="margin-left: 50px;"> {{ item.name }}</h4>
               
             </div>
             <!-- Apellido -->
            <div class="vx-col w-1/2 mb-3 mt-4" :style="[{transitionDelay: (2 * 0.1) + 's'}]">
               <vs-divider position="left" color="primary" >APELLIDO</vs-divider>
               <h4 style="margin-left: 50px;"> {{ item.lastname }}</h4>
              
            </div>
             <!-- Rut -->
            <div class="vx-col w-1/2 mb-3 mt-4">
             <vs-divider position="left" color="primary">RUT</vs-divider>
             <h4 style="margin-left: 50px;">  {{ item.rut }}</h4>
            </div>
            <!-- Empresa -->
            <div class="vx-col w-1/2 mb-3 mt-4">
              <vs-divider position="left" color="primary">EMPRESA</vs-divider>
              <h4 style="margin-left: 50px;"> {{ item.nombreEmpr }}</h4>
            </div>
            <!-- Rol -->
            <div class="vx-col w-1/2 mb-3 mt-4">
              <vs-divider position="left" color="primary">ROL</vs-divider>
              <h4 style="margin-left: 50px;"> {{ item.roles[0].name  }}</h4>
            </div>
             <!-- Email -->
            <div class="vx-col w-1/2 mb-3 mt-4">
              <vs-divider position="left" color="primary">EMAIL</vs-divider>
              <h4 style="margin-left: 50px;"> {{ item.email }}</h4>
            </div>
            <!-- Telefono -->
            <div class="vx-col w-1/2 mb-3 mt-4">
              <vs-divider position="left" color="primary">TELEFONO</vs-divider>
              <h4 style="margin-left: 50px;"> {{ item.telefono }}</h4>
            </div>
             <div class="vx-col w-1/2 mb-3 mt-4">
            </div>
             <!-- Creado -->
            <div class="vx-col w-1/2 mb-3 mt-4">
              ...
              <h4 style="margin-left: 50px;"> {{ item.created_at }}</h4>
            </div>
            <!-- Actualizado -->
            <div class="vx-col w-1/2 mb-3 mt-4">
              <vs-divider position="left" color="primary">ACTUALIZADO</vs-divider>
              <h4 style="margin-left: 50px;"> {{ item.updated_at }}</h4>
            </div>
     ...
     cambiarPassword() {
      ...
      this.$validator.validateAll().then(result =>{
        if (result) {
         ...
         this.$http.post(url, this.credendial) //this.item
            .then((res) =>{
...
<style lang="scss">
@import "@sass/vuesax/pages/profile.scss"
</style>
